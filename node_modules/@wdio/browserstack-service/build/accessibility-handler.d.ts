...
declare class _AccessibilityHandler {
    ...
    private _sessionId;
    private listener;
    constructor(_browser: WebdriverIO.Browser | WebdriverIO.MultiRemoteBrowser, _capabilities: Capabilities.ResolvedTestrunnerCapabilities, isAppAutomate?: boolean, _framework?: string | undefined, _accessibilityAutomation?: boolean | string, _accessibilityOpts?: {
        [key: string]: unknown;
    });
